...
- **Android 模拟器**：推荐 MuMu 模拟器（需开启 ADB 调试）
- **模拟器分辨率**：推荐设置为 1280×720（脚本坐标基于此分辨率设计，会自动缩放适配）
...
| 模拟器 | 默认端口 |
|--------|----------|
| MuMu 模拟器（推荐） | 16384, 16416, 16448 ... |
| 雷电模拟器 | 16384, 16416, 16448 ... |
| 夜神模拟器 | 62001, 62025 ... |
